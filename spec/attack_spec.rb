...
RSpec.describe Attack do
  ...
  describe '#calculate_difficulty_level' do
    context 'when attack is at range 0-15 feet' do
      it 'is easy' do
    ...
    context 'when attack is at range 16-45 feet' do
      it 'is medium' do
    ...
    context 'when attack is at range 46-75 feet' do
      it 'is hard' do
    ...
    context 'when attack is at range 76-150 feet' do
      it 'is very hard' do
    ...
    context 'when attack is at range 151-300 feet' do
    ...
    context 'when attack is at range 301+ feet' do
      it 'is impossible' do
